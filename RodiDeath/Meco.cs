...
namespace RodiDeath
{
    class Meco
    {
        ...
        public Meco(int x, int y, int resX, int resY)
        {
        ...
        public void actualiza(GameTime gameTime)
        {
            ...
            if (Keyboard.GetState().IsKeyDown(Keys.Left) && !seMueve)
            {
                seMueve = true;
                ultimaDireccion = 'I';
            }
            else
                if (Keyboard.GetState().IsKeyDown(Keys.Right) && !seMueve)
                {
                    seMueve = true;
                    ultimaDireccion = 'D';
                }
                else
                    if (Keyboard.GetState().IsKeyDown(Keys.Up) && !seMueve)
                    {
                        seMueve = true;
                        ultimaDireccion = 'A';
                    }
                    else
                        if (Keyboard.GetState().IsKeyDown(Keys.Down) && !seMueve)
                        {
                            seMueve = true;
                            ultimaDireccion = 'B';
                        }
